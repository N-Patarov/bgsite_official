defmodule BgsiteOfficialWeb.AdminResetPasswordControllerTest do
  ...
  describe "GET /admin/reset_password" do
  ...
  describe "POST /admin/reset_password" do
    @tag :capture_log
  ...
  describe "GET /admin/reset_password/:token" do
  ...
  describe "PUT /admin/reset_password/:token" do
    setup %{admin: admin} do
      token =
        extract_admin_token(fn url ->
          Accounts.deliver_admin_reset_password_instructions(admin, url)
