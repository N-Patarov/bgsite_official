defmodule BgsiteOfficialWeb.AdminSettingsControllerTest do
  ...
  describe "PUT /admin/settings (change password form)" do
  ...
  describe "PUT /admin/settings (change email form)" do
    @tag :capture_log
  ...
  describe "GET /admin/settings/confirm_email/:token" do
