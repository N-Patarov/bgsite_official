defmodule BgsiteOfficial.AccountsTest do
  ...
  describe "register_admin/1" do
    ...
    test "registers admin with a hashed password" do
  ...
  import BgsiteOfficial.AccountsFixtures
  alias BgsiteOfficial.Accounts.{User, UserToken}
