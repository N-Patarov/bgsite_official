defmodule BgsiteOfficial.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, BgsiteOfficial.Repo)
  ...
  """
  def valid_password?(%BgsiteOfficial.Accounts.Admin{hashed_password: hashed_password}, password)
